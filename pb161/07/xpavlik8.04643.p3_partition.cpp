...
/**
 ** Quite a hefty solution. Revent remembers more than it needs to.
 ** Only operations done on input sequence are swaps - it is good enough
 ** to remember only swaps done (in order) and on revert just do them,
...
//*  My  lecturer is gonna hate me for it, but many times it is easier to just copy
  ** solution somebody else has alredy figured out. I might be wrong, but
  ** this looks like quite some work (if not, sorry and kudos)!
