...
#include <cstdint>
#include <cassert>
/** I don't see you using this :eyes: **/
#include <cmath>
...
/** Good, it can be simplified even further, if you consider just `d` instead of
 ** `dy, dx` (you're moving along bits, those “steps” with `dy, dx` can be
...
/** OK, I guess… you can also solve it by checking each of the next positions and
 ** whether it collides with the occupied position where you started. **/
