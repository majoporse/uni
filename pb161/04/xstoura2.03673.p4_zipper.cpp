...
struct zipper{
    ...
    /** Good choice of the struct's representation,
     ** makes the operations easy to implement and effective **/
...
/** Clean and straightforward code. One thing that could be done
 ** differently is to use the insert functions inside the shift
 ** functions, but ofcourse, that is only a visual change :). **/
